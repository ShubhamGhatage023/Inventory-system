...
export default function InsertProduct() {
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12 fs-4">
                <label htmlFor="product_barcode" className="form-label fw-bold">Product Quantity</label>
                <input type="number" onChange={setQuantity} value={productQuantity} className="form-control fs-5" id="product_barcode" placeholder="Enter Product Quantity" required />
            </div>
